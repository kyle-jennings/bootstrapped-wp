            ...
            execute: function (o, n, s) {
                ...
                if ("open" === o || "toogle" === o && !c.is(":visible")) {
                    ...
                    t = !0, "left" === v ? (a = {
                        ...
                        right: "0px"
                    }), l = u.scrollTop(), u.css("overflow-x", "hidden").scrollTop(l), c.css("display", "block").animate(d, y, function () {
                    ...
                    t = !0, "left" === v ? (a = {
                        ...
                        right: "-" + p + "px"
                    }), l = u.scrollTop(), u.removeAttr("style").scrollTop(l), c.animate(d, y, function () {
                        c.removeAttr("style"), e("html").removeAttr("style"), t = !1, i = !1, "function" == typeof s && s(n)
                    })
                }
            }
        }, r = {
