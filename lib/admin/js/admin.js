jQuery(document).ready(function($) {
  ...
  $('.js--toggle-field').on('change',function(e){
    ...
    var $fieldFamily = $('.js-toggled-field.'+thisData);
    ...
    if( targetData ){
      ...
      // console.log(thisData, $fieldFamily, targetData);
    }
  ...
  if( $('.layout-diagram').length ){
  	$('[class^="layout-diagram__"]').mouseover(function(e){
  		e.stopPropagation();
