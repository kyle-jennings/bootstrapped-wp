<?php	
		...
		$thumbnailParts =array('thumbnail_background','thumbnail_border','thumbnail_glow','thumbnail_text');
?>
<div class="tabbable"> <!-- Only required for left/right tabs -->
  ...
  <div class="tab-content">
	...
	?>
		...
		<input type="minicolors" class="minicolors" data-default="none" name="kjd_<?php echo $section;?>_forms_settings[kjd_<?php echo $section;?>_forms][kjd_image_border][color]"
