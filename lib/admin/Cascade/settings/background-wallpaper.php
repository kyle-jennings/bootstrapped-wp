...
$wallpaper = array(
    'background_use_wallpaper'=>new Select(
        array(
    ...
    'background_image'=>new File(
        array(
            'name'=>'background_image',
            'label'=>'Upload Image',
        )
    ),
    'background_repeat'=>new Select(
        array(
    ...
    'background_attachment'=>new Select(
        array(
    ...
    'background_position'=>new Select(
        array(
    ...
    'background_positionY'=>new Select(
        array(
    ...
    'background_percentage'=>new Text(
        array(
