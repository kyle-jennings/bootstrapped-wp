...
foreach($image_types as $image){
    $images[$image] = array(
        ...
        'fields'=>array(
            ...
            $image.'_border_style'=>select_field(array(
            ...
            $image.'_hover_glow_rgba' => no_field(
                array(
            ...
            $image.'_background_color_rgba'=>no_field(
                    array(
            ...
            $image.'_border_radius'=>select_field( array(
