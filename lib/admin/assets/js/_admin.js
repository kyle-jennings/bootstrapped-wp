...
},{"./addSuffix":2,"./dropdown-nav":3,"./dropdown-subnav-links":4,"./expand-textarea":5,"./extendFields":6,"./form-saved":7,"./getCookie":8,"./insertParam":9,"./media-library":10,"./minicolors":11,"./notification-auto-dismiss":12,"./overlay":13,"./preview-affix":14,"./preview-ajax":15,"./preview-custom-code":16,"./preview-general":17,"./preview-send-values":18,"./preview-size":19,"./preview-textarea-update":20,"./removeNag":21,"./toggle-fields":22,"./update-last-group-and-tab":23,"./vendor/colorpicker/minicolors":24,"jquery":25}],2:[function(require,module,exports){
...
var send_to_preview = {
  ...
  load_styles: function() {
    ...
    var timestamp = Date.now();
      ...
      $preview.contents().find('head').append( link ).siblings('#preview').remove();
  	}else {
      $preview.contents().find('head').append( link ).siblings('#site-css').remove();
    }


    var $previewWrapper = $('.preview-wrapper');
    $previewWrapper.delay(3000).removeClass('reloading');
  },
