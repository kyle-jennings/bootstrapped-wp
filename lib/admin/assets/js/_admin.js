...
},{"./addSuffix":2,"./dropdown-nav":3,"./dropdown-subnav-links":4,"./expand-textarea":5,"./extendFields":6,"./form-saved":7,"./getCookie":8,"./hiddenfield-change":9,"./insertParam":10,"./media-library":11,"./minicolors":12,"./notification-auto-dismiss":13,"./overlay":14,"./preview-affix":15,"./preview-ajax":16,"./preview-custom-code":17,"./preview-general":18,"./preview-send-values":19,"./preview-size":20,"./preview-textarea-update":21,"./removeNag":22,"./sidebar-diagram":23,"./sortable":24,"./toggle-fields":25,"./update-last-group-and-tab":26,"./vendor/colorpicker/minicolors":27,"jquery":28}],2:[function(require,module,exports){
...
$('.nav-dropdown a').on('click', function(e){
    ...
    $groupTabTarget.removeClass(function(i){
      // console.log('removing fields wrapper class');
      return 'hide';
    }).siblings('.components-nav__link-wrapper').addClass('hide');
...
$('.upload_image').click( function(e){
  ...
  var field = $this.prev('.media_input').attr('name');
  ...
  send_to_preview.init( section, field, url );
...
$('.minicolors').each(function(){
  ...
  $(this).minicolors({
    ...
    hide: function(hex, opacity){
      ...
      var $this = $(this);
      var value = $(this).minicolors('rgbaString');
      var section = '';
...
$('.clearColor').on('click',function() {
  ...
  var $parent = $(this).closest('.field.ColorPicker');
  $parent.next('.field.Hidden').find('input').val('');
...
setInterval(function(){
  // if($('body.bswp .is-dismissible').length > 0 ){
  // }
  $('body.bswp .is-dismissible').fadeOut();
}, 3000);
...
window.custom_code_preview = custom_code_preview;
...
var send_to_preview = {
  ...
  load_styles: function() {
    ...
    if( $preview.contents().find('head').find('#site-css').length ){

      $preview.contents().find('head').append( link );
      $preview.contents().find('head #site-css').remove();
    }
...
// This removes the notifcation for updates
