...
},{"./addSuffix":2,"./ajax-preview":3,"./custom-code-preview":4,"./extendFields":5,"./fieldToggles":6,"./form-saved":7,"./getCookie":8,"./group-dropdown":9,"./insertParam":10,"./live-preview":11,"./mediaLibrary":12,"./minicolors":13,"./preview-affix":14,"./previewSize":15,"./removeNag":16,"./send-to-preview":17,"./tab-dropdown":18,"./vendor/colorpicker/minicolors":19,"jquery":20}],2:[function(require,module,exports){
...
$('.bswp-form input, .bswp-form select, .custom-styles').not('.preview-size').change(function(){
  ...
  if(previewType == 'form_save_warning'){
    ...
    var deps = $this.data('preview-deps');
    ...
    console.log('requires form save');
  }
