...
/**
 * WTF is the different between this and 'kjd_build_mobile_styles_callback' ?
...
function navbarStylesCallback( $preview ){
    ...
    $kjd_section_text = kjd_get_temp_settings(  $section,
                                                $navbarLinksOptions['kjd_navbar_text'],
                                                $preview,
                                                'kjd_section_text'
                                        );
...
------------------------------------------------------------------- */
    ...
    $navbar_markup .= '.navbar .brand.brand--menu-button {';

        if( $kjd_section_text['bg_color'] != ''){

        }else{
            $navbar_markup .= 'background-color: transparent;';
        }

        $navbar_markup .= 'background-color:'.$kjd_section_text['bg_color'].';';
        $navbar_markup .= 'color:'.$kjd_section_text['color'].';';

        if( in_array($kjd_section_misc_settings['navbar_link_style'], array('pills', 'tabs', 'tabs-below') ) ){
            $navbar_markup .= 'border-color:'.$kjd_section_text['border_color'].';';
        }
        $navbar_markup .= 'text-decoration:'.$kjd_section_text['decoration'].' !important;';
    $navbar_markup .= '}';
...
------------------------------------------------------------------ */
    ...
    $navbar_markup .= ".navbar .nav li.open > a:after{";
    	$navbar_markup .= "border-color:".$kjd_section_linkHovered['color'].";";
    $navbar_markup .= "}";
